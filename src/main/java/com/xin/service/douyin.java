...
/**
 *  通过分享链接下载无水印视频
 *  https://blog.csdn.net/yuanyixuan23/article/details/109740036
 */
public class douyin {

    public static void main(String[] args) throws Exception {
//        String url = "https://v.douyin.com/JHR8buj/";
        String url = "5.15 Ymq:/ 潘长江儿子回家看望潘长江，潘长江：是不是雾霾太大走错路了。%小品 %喜剧 %搞笑   https://v.douyin.com/dMP4C9L/ 复制此链接，打開Dou搜索，直接觀看视频！";
    ...
    private static void downloadVideo(String videoAddress,String desc) {
        int byteRead;
        try {
//           videoAddress = "https://www.douyin.com/video/6995915712216747268";
